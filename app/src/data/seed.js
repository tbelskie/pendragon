  ...
  products: [
    {
      ...
      setupProfile: {
        businessModel: "one-time-license",
        currentGoal: "beta",
        hasPrototype: "yes",
        hasRepo: "yes",
        isCharging: "no",
        productType: "desktop-app",
        sourceLink: "https://github.com/tbelskie/writing-quest",
        stageOverride: "auto",
        traction: "Internal build is active; beta trust depends on save/export confidence.",
        usersHaveAccess: "no"
      },
    ...
    },
    {
      ...
      setupProfile: {
        ...
        sourceLink: "",
        stageOverride: "auto",
        traction: "53 installs, 14 actual users, 16 weekly users, and roughly 10 daily users with no active marketing.",
        usersHaveAccess: "yes"
      },
    ...
    },
    {
      ...
      setupProfile: {
        ...
        sourceLink: "",
        stageOverride: "auto",
        traction: "Previously ran as a hosted fake-business API; current relaunch proof depends on restoring one excellent vertical.",
        usersHaveAccess: "no"
      },
    ...
    },
    {
      ...
      setupProfile: {
        ...
        sourceLink: "",
        stageOverride: "auto",
        traction: "Concept and early build exist; public trust signal still needs validation.",
        usersHaveAccess: "no"
      },
    ...
    },
    {
      ...
      setupProfile: {
        ...
        currentGoal: "prototype",
        hasPrototype: "yes",
        hasRepo: "yes",
        isCharging: "no",
        productType: "web-app",
        sourceLink: "https://github.com/tbelskie/pendragon",
        stageOverride: "auto",
        traction: "Internal dogfood is active; outside beta should wait for Writing Quest and one secondary portfolio case.",
        usersHaveAccess: "no"
      },
